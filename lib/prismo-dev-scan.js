...
Usage:
  ...
  prismo watch [codex|claude|all] [--json] [--once] [--report] [--redact-paths] [--interval N] [path]
  prismo demo
...
Output:
  Shows context pressure, recent growth, likely context leaks, repeated reads/commands, loop suspicion, and one suggested action.`,
    dev: `PrismoDev
