...
Usage:
  ...
  prismo watch [codex|claude|all] [--json] [--once] [--report] [--rescue] [--guardrails] [--throttle] [--auto] [--budget N] [--redact-paths] [--interval N] [path]
  prismo demo
...
Options:
  ...
  --auto     Opinionated live protection: guardrails + throttle + default 600k budget.
...
Output:
  ...
  --auto enables guardrails and throttle with a 600k default budget.`,
    dev: `PrismoDev
