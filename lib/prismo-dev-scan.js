...
Output:
  Runs the command locally, stores full stdout/stderr under .prismo/shield/runs/, and prints only a compact summary plus useful error lines.
  This is a lightweight context-sandbox workflow: full output stays on disk unless you explicitly inspect it.`,
    ci: `Prismo CI
