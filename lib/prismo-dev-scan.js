...
Usage:
  ...
  prismo watch [codex|claude|all] [--json] [--once] [--report] [--rescue] [--guardrails] [--throttle] [--events] [--auto] [--budget N] [--redact-paths] [--interval N] [path]
  prismo demo
...
async function runCli(argv) {
  ...
  if (command === "usage" || command === "watch") {
    ...
    const usageOptions = {
      ...
      events: auto || rest.includes("--events"),
